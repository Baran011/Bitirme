...
Button button8;
button8.setParent(&window2);
button8.setPosition(sf::Vector2f(990, 520));

sf::Texture texture8;
texture8.loadFromFile("images/ciftlikButton.jpg");
button8.setTexture(texture8);

Button button9;
button9.setParent(&window2);
button9.setPosition(sf::Vector2f(1260, 520));

sf::Texture texture9;
texture9.loadFromFile("images/farkBulma2.jpg");
button9.setTexture(texture9);
	...
	while (window2.pollEvent(event))
	{
		...
		case sf::Event::MouseButtonPressed:
			...
			*/
			...
			if (button8.isMouseClick(sf::Mouse::Left))
			{
				window2.close();
				sound.stop();
				sound2.play();
			...
			if (button8.isMouseOver())
			{
				button8.setSize(sf::Vector2f(180, 230));
			}
			else
			{
				button8.setSize(sf::Vector2f(150, 200));
			}
			if (button9.isMouseClick(sf::Mouse::Left))
			{
				window2.close();
				sound.stop();
				sound2.play();
			...
			if (button9.isMouseOver())
			{
				button9.setSize(sf::Vector2f(180, 230));
			}
			else
			{
				button9.setSize(sf::Vector2f(150, 200));
			}
		}
		...
		window2.draw(button8);
		window2.draw(button9);
		window2.display();
