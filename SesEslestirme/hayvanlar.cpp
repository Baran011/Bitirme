...
///////////////////////////////////////////////////////////////////////////////
	...
	int dizi[10][2] = { {100,280},{100,430},{ 100,580 },{ 100,730 },{ 100,880 },{ 450,280 },{ 450,430 },{ 450,580 },{ 450,730 },{ 450,880 } };        // Farklý pozisyonlarýn tanýmlarý
	int diziPng[10][2] = { { 880,280 },{ 880,430 },{ 880,580 },{ 880,730 },{ 880,880 },{ 1230,280 },{ 1230,430 },{ 1230,580 },{ 1230,730 },{ 1230,880 } }; //Png ler için farklý pozisyonlar tanýmlar
	int kontrol = -1;
	int puan = 0;
	int sayac = 0;
	...
	while (window.isOpen())
	{
		...
		if (sayac==10)
		{
			...
			if (puan==10)
			{
				dead.setString("Skorunuz :" + std::to_string(puan)+" Tebrikler oyunu kazandýn");
				
			}
			else if (puan<10 && puan >=8)
			{
				dead.setString("Skorunuz :" + std::to_string(puan) + " Kazanmaya çok yakinsin \n                çalismaya devam...");
			}
			else if (puan<8 && puan >= 5)
			{
				dead.setString("Skorunuz :" + std::to_string(puan) + " Yolu yariladin böyle \n               çalismaya devam et. ");
			}
			else if (puan<5 && puan >= 3)
			{
				dead.setString("Skorunuz :" + std::to_string(puan) + " Ögrenmeye baþladiðini \n               görüyorum ");
			}
			else if (puan<3 && puan >= 0)
			{
				dead.setString("Skorunuz :" + std::to_string(puan) + " Biraz kötü bir sonuç \n        ama çaliþarak üstesinden geliceksin.");
			}else
				dead.setString("Skorunuz :" + std::to_string(puan) + " Talihsizlik! Ögrenmeye \n             devam etmelisin.");
		}
